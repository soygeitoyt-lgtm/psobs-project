...
function generateRandomRoomId(): string {
  // Sufijo largo para minimizar choques con otros usuarios en el servidor PeerJS público
...
export default function App() {
  ...
  useEffect(() => {
    ...
    if (urlRoom) {
      ...
      // Preservar TODOS los params existentes (incluido role) al sincronizar la URL
